	...
	*/
	for(i=0;i<max_iterations;i++)
	{
		...
		*/
		...
		in_cnt=recvfrom(ssd, client_string, BUF_LEN, 0, (struct sockaddr *)&client,(socklen_t *)&client_len);
		...
		*/
		...
		out_cnt = sendto(ssd, server_reversed_string, recv_cnt+1, 0, (struct sockaddr *)&client, sizeof(client));
